// ================================================================
// RP Management Subsystem - Memories (ssrpmanagement_memories.dm)
// ================================================================
// Handles:
...
// ================================================================
// ---------------- REGISTER / LOOKUP ----------------
/datum/controller/subsystem/rpmanagement/proc/register_memory(datum/memory/M)
	if (M?.id && is_valid_key(M.id))
		GLOB.memories[M.id] = M

/datum/controller/subsystem/rpmanagement/proc/get_memory_by_key(key)
	return is_valid_key(key) ? GLOB.memories[key] : null

/datum/controller/subsystem/rpmanagement/proc/unregister_memory(datum/memory/M)
	if (M?.id)
		GLOB.memories -= M.id

// ---------------- MEMORY CREATORS ----------------
/datum/controller/subsystem/rpmanagement/proc/ensure_entry_memory_for_key(character_key, mob/living/carbon/human/owner)
