...
/client/verb/DebugRPManagement()
	...
	summary += "</details><br>"
	// --- Output ---
	src << browse("<html><body style='background-color:#1e1e1e; color:#dcdcdc; font-family:monospace'>" + summary.Join("") + "</body></html>", "window=roleplay_management_debug;size=1000x800")
