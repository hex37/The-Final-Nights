...
/datum/group/proc/to_chat_group(msg)
	...
	for (var/ckey in all)
		var/datum/component/about_me/C = SSroleplay_management.find_aboutme_component_by_character_id(ckey)
...
/datum/group/proc/invite_member_prompt(officer_key, target_key)
	...
	var/datum/component/about_me/C_officer = SSroleplay_management.find_aboutme_component_by_character_id(officer_key)
	var/datum/component/about_me/C_target = SSroleplay_management.find_aboutme_component_by_character_id(target_key)
